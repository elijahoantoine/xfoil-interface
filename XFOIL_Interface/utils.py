...
#======== Utility Functions for Polar Data ========
...
def display_results(results):
    '''Display the extracted results from the PACC file in a clear tabular format. This includes CL, CD, CM, and if viscous, CDp, CDf, and transition locations for each AoA point.'''
    print("\n--- XFOIL Results ---")
...
# ======= Experimental Data Loading Function ========
